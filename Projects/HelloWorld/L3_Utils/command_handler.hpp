 ...
 */
typedef bool (*CmdHandlerFuncPtr)(str& cmdParams, UartDev& output, void* pDataParam, int dataParamLen);
 ...
 * @endcode
 */
#define CMD_HANDLER_FUNC(name) bool name(str& cmdParams, UartDev& output, void* pDataParam, int dataParamLen)
