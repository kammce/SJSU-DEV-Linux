...
#define MESH_PKT_DISC_TIMEOUT_MS     3  ///< Destined node is given this time before we send repeat the packet.
...
/**
 * Define the debug print method.  If you do not wish to use it, just
 * define it to nothing: ie: "#define MESH_DEBUG_PRINTF(x)"
 */
#if 0
    #include <stdio.h>
    #include <time.h>
