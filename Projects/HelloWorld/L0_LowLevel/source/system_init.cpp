...
static sys_boot_t m_sys_boot_type = SysBootType_unknown; // Store reboot type for anyone to query
...
static void print_boot_info(void)
{
    if (LPC_SC->RSID & 1) {
        ...
        m_sys_boot_type = SysBootType_unknown;
    }
}
