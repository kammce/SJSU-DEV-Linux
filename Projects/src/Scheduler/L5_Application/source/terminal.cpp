...
bool terminalTask::taskEntry()
{
    ...
    cp.addHandler(onDemandTemperatureHandler, "temp",    "On Demand Temperature Sensor data");
    ...
    cp.addHandler(UARTHandler, "uart", "UART COM Handler for toggling leds and getting pitch data.");
