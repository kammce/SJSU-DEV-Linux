    ...
    mKHz(kHz_enabled)
{
  ...
  //  vTraceSetSemaphoreName(sems[prd_1Hz], "1Hz_Sem");
   ...
   // vTraceSetSemaphoreName(sems[prd_100Hz], "100Hz_Sem");
    ...
    xTaskCreate(period_task_1Hz, "1Hz", PERIOD_TASKS_STACK_SIZE_BYTES/4, NULL, PRIORITY_CRITICAL + 2, NULL);
    xTaskCreate(period_task_10Hz, "10Hz", PERIOD_TASKS_STACK_SIZE_BYTES/4, NULL, PRIORITY_CRITICAL + 1, NULL);
